...
os.environ["WANDB_PROJECT"] = "detr-res50-coco-caronly-lnt" 
...
config = LNTuningConfig(
    target_modules = ["self_attn_layer_norm","final_layer_norm","encoder_attn_layer_norm","layernorm"],
...
training_args = TrainingArguments(
    output_dir="results/detr-r50-coco-caronly-lnt",
    push_to_hub=True,
    ...
    eval_strategy = "steps",
    hub_model_id="carbohydration/detr-coco-caronly-lnt",
    report_to="wandb"
    )
